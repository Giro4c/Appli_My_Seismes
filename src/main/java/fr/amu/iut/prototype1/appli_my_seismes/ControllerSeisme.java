...
public class ControllerSeisme {
    ...
    //Overview
    @FXML
    private void OuvreOverview(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("Overview.fxml"));
        Parent root = loader.load();

//        ControllerOverview controllerOverview = loader.getController();
//        controllerOverview.setControllerSeisme(this);
